...
export function PeriodIndicator(props: PeriodIndicatorProps): JSX.Element {
    ...
    return <div className="fixed top-0 w-full mt-28 flex justify-center">
        <motion.div className={`${baseConfig} border border-1 z-10 text-slateA-1`}
        ...
        <motion.div className={`${baseConfig} bg-gray-800 bg-o-30 z-0 bg-opacity-50`}
