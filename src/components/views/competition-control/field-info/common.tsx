...
function MatchName (props: { match: MatchIdentifier | null }): JSX.Element {
...
function getOutlineColor (match: MatchIdentifier | null, status: FieldStatus | undefined): OutlineColor {
  if (match === null) {
